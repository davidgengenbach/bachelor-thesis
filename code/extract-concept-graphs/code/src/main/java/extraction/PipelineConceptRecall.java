...
public class PipelineConceptRecall {

	public static final String dataFolder = "data/WikiCMaps/test";
	public static final String mapFolder = "data/WikiCMaps/test_system";
	public static final String mapName = "extraction-noun-10-conjarg2";
	...
	public static void main(String[] args) throws UIMAException, IOException {
		...
		for (File clusterFolder : folder.listFiles()) {
			if (clusterFolder.isDirectory()) {
				...
				String[] pipeline = { "extraction.PropositionExtractor", "extraction.AllPropsMap" };
