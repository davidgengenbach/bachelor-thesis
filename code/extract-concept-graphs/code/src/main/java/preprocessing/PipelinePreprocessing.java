 ...
 * 
 * models from corenlp 3.7.0
 */
public class PipelinePreprocessing {

	// dataset to be processed
	public static String textFolder = "data/WikiCMaps/train";
	...
	public static void main(String[] args) throws UIMAException, IOException {
		...
		// english-left3words-distsim.tagger - WSJ+extra, 89.81, fast
		// english-bidirectional-distsim.tagger - WSJ+extra, 90.46, slow
		AnalysisEngineDescription pos = AnalysisEngineFactory.createEngineDescription(StanfordPosTagger.class,
				...
				StanfordPosTagger.PARAM_MODEL_LOCATION, "ext_models/pos_tagger/english-left3words-distsim.tagger");
		...
		AnalysisEngineDescription ner = AnalysisEngineFactory.createEngineDescription(
				...
				"ext_models/ner/english.all.3class.distsim.crf.ser.gz");
		...
		AnalysisEngineDescription parser = AnalysisEngineFactory.createEngineDescription(StanfordParser.class,
				...
				StanfordParser.PARAM_MODEL_LOCATION, "ext_models/parser/englishRNN.ser.gz", StanfordParser.PARAM_MODE,
				DependenciesMode.CC_PROPAGATED);

		// coreference resolution
		// AnalysisEngineDescription coref =
		// AnalysisEngineFactory.createEngineDescription(
		// StanfordCoreferenceResolver.class,
		// StanfordCoreferenceResolver.PARAM_MODEL_LOCATION,
		// "ext_models/dcoref");
		...
		// 4) run pipeline
		SimplePipeline.runPipeline(reader, segmenter, pos, lemmatizer, ner, parser, // coref,
				writer, stat);
	}
