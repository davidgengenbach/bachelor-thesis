 ...
 */
public class PipelineFeatureExtraction {
	...
	public static final String mapName = "features";
	...
	public static void main(String[] args) throws UIMAException, IOException {
		...
		for (File clusterFolder : folder.listFiles()) {
			if (clusterFolder.isDirectory()) {
				...
				String[] pipeline = { "extraction.PropositionExtractor", "grouping.ConceptGrouperSim", };
