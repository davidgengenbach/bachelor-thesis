...
\todo[inline]{In Chapter \ref{sec:implementation} we introduce the concept map extraction implementation we used and further explain the steps in creating the concept maps.}


\todo[inline]{"Capture important concepts and the structure of texts (spanning over whole text)"}
\todo[inline]{Advantages}
\todo[inline]{Text summarization}
...
\todo[inline]{Difference of graph isomorphism and graph kernels}

\todo[inline]{Creating a graph kernel is always a trade-off}
\todo[inline]{Kernels can be combined!}
\todo[inline]{Mention similarity of graph kernel task to graph isomorphism test}
...
\todo[inline]{Mention R-Convolution?}
