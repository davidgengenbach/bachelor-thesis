...
%The aforementioned graph kernel $k_{simple\_structure}$ is an example for this approach. In this kernel the sub-structures are triangle and rectangle subgraphs.
...
\todo{Explain extensions/modifications we actually used.}
