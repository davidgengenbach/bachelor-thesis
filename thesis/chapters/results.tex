...
We used only datasets from the website that have more than 1000 graphs and node labels.
...
On the graph benchmark datasets on the other hand, we can also observe significant improvements.
