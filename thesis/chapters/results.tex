...
\begin{table}[htb!]
	...
	\begin{tabular}{lrr}
		...
		\bottomrule
	\end{tabular}
	\caption[Statistics: Percentage of concepts occurring only once]{Percentage of concepts that occur only once in the dataset. Per graph type and dataset.}\label{table:percentage_concept_only_once}
\end{table} 
...
\begin{figure}[htb!]
	...
	{\includegraphics[width=\linewidth]{assets/figures/combined_coefs_l1_l2_regularization.pdf}%
		\caption[Statistics: Histogram of trained one-layer neural net]{%
