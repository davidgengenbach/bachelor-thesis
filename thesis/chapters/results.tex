...
One additional step to further increase the likelihood of matches between the single-word nodes would be to lemmatize or stem [p.~4]\cite{Manning2000} the individual words.
