...
Since we are mainly interested in the structure of concept maps and how they can be useful for text classification, we also establish a baseline to another graph representation for the text.
