...
This dataset consists of news articles collected and published by Carnegie Group and Reuters.
 ...
 Some of the articles have multiple classes assigned. For our purposes, single-label classification, we only used articles with one class.
 We also only use articles which consist of more than 20 words, so that meaningful concept maps can be created.
