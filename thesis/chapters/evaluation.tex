...
\begin{figure}[ht]
  ...
  In the histogram of observed differences \textbf{\subref{fig:permutation_test_distribution}} this $f_{higher}$ corresponds to the area of the red surfaces divided by the observations between the red lines.
